...
namespace EfDbFirstDemo.DataAccess
{
    public partial class ChinookContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.ToTable("Department", "Office");
            ...
            {
                entity.ToTable("EmpDetails", "Office");
                ...
                entity.HasOne(d => d.Employee)
                    ...
                    .HasConstraintName("FK__EmpDetail__Emplo__0B91BA14");
            });
            ...
            {
                entity.ToTable("Employee", "Office");
                ...
                entity.HasOne(d => d.Dept)
                    ...
                    .HasConstraintName("FK__Employee__DeptID__0A9D95DB");
            });
